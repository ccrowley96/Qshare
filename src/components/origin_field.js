...
class OriginField extends React.Component {
  ...
  dangerFlag(){
    ...
    const input_wrapper = document.getElementsByClassName("places-wrapper");
    const text_help = document.getElementsByClassName("places-text-help");
  ...
  render() {
    ...
    const cssClasses = {
      input: 'form-control',
      autocompleteContainer: 'places-container'
    }
    ...
    return (
      <div className='places-wrapper form-group'>
        <label>{this.state.label}</label>
          ...
          />
          <div className="text-help places-text-help">Enter Valid Origin</div>
      </div>
    )
  }
}
